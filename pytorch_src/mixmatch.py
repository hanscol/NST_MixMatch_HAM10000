...
parser.add_argument('--rampup_length', default=100, type=int, metavar='N',
...
parser.add_argument('--val-iteration', type=int, default=1024,
                        help='Number of labeled data')
parser.add_argument('--out', default='result_mixmatch',
                        help='Directory to output the result')
parser.add_argument('--alpha', default=0.75, type=float)
parser.add_argument('--nst_alpha', default=0.0, type=float)
...
def main():
    ...
    train_labeled_set = dataset('/nfs/masi/hansencb/nlst_nst_mixmatch/data_organization/train_labeled_243.csv', labeled=True, train=True)
    train_unlabeled_set = dataset('/nfs/masi/hansencb/nlst_nst_mixmatch/data_organization/train_unlabeled_243.csv', labeled=False, train=True)
    val_set = dataset('/nfs/masi/hansencb/nlst_nst_mixmatch/data_organization/val.csv', labeled=True, train=False)
    test_set = dataset('/nfs/masi/hansencb/nlst_nst_mixmatch/data_organization/test.csv', labeled=True, train=False)
...
def train(labeled_trainloader, unlabeled_trainloader, model, optimizer, ema_optimizer, criterion, epoch, use_cuda):
    ...
    for batch_idx in range(args.val_iteration):
        ...
        loss = Lx + w * Lu + linear_rampup(epoch) * args.nst_alpha * nst_loss
